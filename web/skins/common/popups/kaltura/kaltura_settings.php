...
define('WORK_WITH_KSHOW', FALSE);
  ...
  define('KalturaSettings_CW_UICONF_ID', 1000682);
  define('KalturaSettings_SE_UICONF_ID', 1001536);
  define('KalturaSettings_PLAY_MIX_UICONF_ID', 1000611);
  define('KalturaSettings_PLAY_NOMIX_UICONF_ID', 1000610);
