...
<div class="field" id="deki-external-auth">
	...
	<fieldset class="external">
		...
		<span class="label"><?php echo $this->msg('Users.form.authentication.external.username'); ?></span> <?php echo DekiForm::singleInput('text', 'external_auth_username'); ?><br/>
		<span class="label"><?php echo $this->msg('Users.form.authentication.external.password'); ?></span> <?php echo DekiForm::singleInput('password', 'external_auth_password'); ?>
	</fieldset>
</div>
