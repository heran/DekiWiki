...
<form method="post" action="<?php $this->html('form.action'); ?>" class="skins">
	<div class="skins">
		...
		<div class="field">
					...
					<ul>
						<?php
							...
							{						
								...
								echo '<li class="'. ($details['selected'] ? 'selected-skin selected' : '') . (' ' . $details['class']) .'">';
			...
			<div class="field skin-display-options">
				<?php echo DekiForm::singleInput('checkbox', 'beta', null, array(), $this->msg('Skinning.label.showbeta')); ?>
				<?php echo DekiForm::singleInput('checkbox', 'obsolete', null, array(), $this->msg('Skinning.label.showobsolete')); ?>
			</div>
